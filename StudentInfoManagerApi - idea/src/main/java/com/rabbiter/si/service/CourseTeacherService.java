...
import com.rabbiter.si.mapper.CourseTeacherMapper;
...
public class CourseTeacherService {
    ...
    public List<CourseTeacherInfo> findCourseTeacherInfo(Map<String, String> map) {
        ...
        List<CourseTeacherInfo> courseTeacherInfo = courseTeacherMapper.findCourseTeacherInfo(tid, tname, tFuzzy, cid, cname, cFuzzy);
        System.out.println(courseTeacherInfo);
